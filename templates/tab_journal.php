<div class="tab-pane fade" id="t-journal">
    <div class="card border-0 shadow-sm mb-4 glass">
        <div class="card-header bg-transparent border-0 pt-4 px-4">
            <h5 class="fw-bold mb-0 text-custom-accent"><i class="bi bi-journal-check me-2"></i>سجل اليوميات الميدانية</h5>
            <p class="text-custom-muted small mb-0">توثيق سير العمل اليومي، حالة الطقس، والملاحظات الفنية</p>
        </div>
        <div class="card-body p-4">
            <form method="POST" class="row g-3">
                <div class="col-md-3">
                    <label class="form-label small fw-bold text-custom-muted">التاريخ</label>
                    <input type="date" name="j_date" class="form-control" value="<?= date('Y-m-d') ?>" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label small fw-bold text-custom-muted">حالة الطقس</label>
                ...
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-custom-muted">المواد المستلمة اليوم</label>
                    <input name="deliveries" class="form-control" placeholder="مثلاً: وصول حمولة رمل...">
                </div>
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-custom-muted">ملاحظات الإنجاز</label>
                    <textarea name="progress" class="form-control" rows="2" placeholder="ماذا تم إنجازه اليوم؟"></textarea>
                </div>
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-custom-muted">عقبات أو مشاكل</label>
                    <textarea name="issues" class="form-control" rows="2" placeholder="أي معوقات واجهت العمل..."></textarea>
                </div>
                <div class="col-12 text-end">
                    <button name="add_journal" class="btn btn-custom-accent px-5"><i class="bi bi-save me-2"></i>حفظ سجل اليوم</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-custom-glass text-custom-main border fw-normal"><?= h($j['weather']) ?></span></td>
                            <td><small class="text-custom-muted"><?= mb_strimwidth(h($j['progress_notes']), 0, 50, "...") ?></small></td>
