<div class="tab-pane fade" id="t-gallery">
    <div class="card border-0 shadow-sm mb-4 glass">
        <div class="card-header bg-transparent border-0 pt-4 px-4">
            <h5 class="fw-bold mb-0 text-custom-accent"><i class="bi bi-images me-2"></i>معرض صور ومرفقات المشروع</h5>
            <p class="text-custom-muted small mb-0">كافة الصور والفواتير والمرفقات التي تم رفعها للنظام</p>
        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-3 col-lg-2">
                    <div class="card h-100 border-0 shadow-sm overflow-hidden">
                        ...
                        <?php else: ?>
                            <div class="bg-custom-glass d-flex align-items-center justify-content-center" style="height: 150px;">
                                <i class="bi bi-file-earmark-pdf text-danger display-4"></i>
                            </div>
                        <?php endif; ?>
                        <div class="card-body p-2 text-center">
                            <small class="fw-bold d-block text-truncate"><?= h($f['name']) ?></small>
                            <small class="text-custom-muted" style="font-size: 0.7rem;"><?= $f['date'] ?></small>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
                ...
                <?php if(empty($all_files)): ?>
                    <div class="col-12 text-center py-5">
                        <i class="bi bi-image text-custom-muted display-1 opacity-25"></i>
                        <p class="text-custom-muted mt-3">لا توجد صور أو مرفقات مرفوعة لهذا المشروع بعد.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
