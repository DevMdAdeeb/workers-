<div class="row justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="col-md-5">
        <div class="card border-0 shadow-lg overflow-hidden animate__animated animate__zoomIn login-glass">
            <div class="card-header p-4 text-center border-0 bg-transparent">
                <i class="bi bi-shield-lock display-4 d-block mb-2"></i>
                <h4 class="fw-bold mb-0">نظام إدارة الإعمار</h4>
                <p class="small mb-0">يرجى تسجيل الدخول للمتابعة</p>
            </div>
            <div class="card-body p-4 p-md-5">
                ...
                <form method="POST" id="authForm">
                    <div class="mb-3">
                        ...
                        <div class="input-group glass rounded-2 overflow-hidden">
                            <span class="input-group-text border-0 bg-transparent"><i class="bi bi-person"></i></span>
                            <input name="username" class="form-control border-0 py-2" placeholder="أدخل اسم المستخدم" required autofocus>
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="form-label small fw-bold">كلمة المرور</label>
                        <div class="input-group glass rounded-2 overflow-hidden">
                            <span class="input-group-text border-0 bg-transparent"><i class="bi bi-key"></i></span>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <button type="button" class="btn btn-link btn-sm p-0 fw-bold text-warning" id="toggleBtn" onclick="toggleAuth()">إنشاء حساب جديد</button>
                    </div>
                </form>
            </div>
