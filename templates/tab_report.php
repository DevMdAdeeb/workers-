<div class="tab-pane fade" id="t-rep">
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 pt-4 px-4">
            <h5 class="fw-bold mb-0 text-primary"><i class="bi bi-file-earmark-bar-graph me-2"></i>مركز التقارير والاستعلامات</h5>
            <p class="text-muted small mb-0">استخراج تقارير تفصيلية شاملة للمشروع أو لعمال محددين</p>
        </div>
        <div class="card-body p-4">
            <div class="row g-4">
                <!-- تقرير المشروع الشامل -->
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-sm bg-primary bg-opacity-10 p-4 border-start border-primary border-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0">كشف حساب شامل لكافة المصروفات والديون</p>
                            </div>
                        </div>
                        <a href="report.php?pid=<?= $pid ?>" target="_blank" class="btn btn-primary w-100 py-3 fw-bold mt-auto">
                ...
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-sm p-4 border-start border-info border-4">
                        ...
                        <form method="POST" class="row g-2">
                            <div class="col-12">
                                <label class="small fw-bold text-muted mb-1">اسم العامل</label>
                                <select name="worker_name" class="form-select border-0 bg-light py-2" required>
                            ...
                            <div class="col-6">
                                <label class="small fw-bold text-muted mb-1">من تاريخ</label>
                                <input type="date" name="date_from" class="form-control border-0 bg-light" value="<?= date('Y-m-01') ?>">
                            </div>
                            <div class="col-6">
                                <label class="small fw-bold text-muted mb-1">إلى تاريخ</label>
                                <input type="date" name="date_to" class="form-control border-0 bg-light" value="<?= date('Y-m-d') ?>">
                            </div>
                    ...
                    <div class="row g-0">
                        <div class="col-md-4 border-end">
                            <div class="p-4 text-center">
                                <span class="text-muted small d-block mb-1">إجمالي المستحقات</span>
                                <h3 class="fw-bold text-dark"><?= number_format($report_data['total']) ?></h3>
                            </div>
                        </div>
                        <div class="col-md-4 border-end">
                            <div class="p-4 text-center">
                        ...
                        <div class="col-md-4">
                            <div class="p-4 text-center">
                                <span class="text-muted small d-block mb-1">المبلغ المتبقي</span>
                                <h3 class="fw-bold text-danger"><?= number_format($report_data['rem']) ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="p-3 bg-light text-center border-top">
                        <p class="text-muted small mb-0">هذا الملخص بناءً على العمليات المسجلة ضمن التواريخ المحددة أعلاه فقط.</p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
